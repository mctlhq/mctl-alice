  ...
  return `
    ...
    <div style="display: flex; flex-direction: column; gap: 16px;">
      ...
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        ...
        <p style="margin: 0; font-size: 14px; line-height: 1.6;" data-i18n="about_operator_desc">
      ...
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        ...
        <p style="margin: 0; font-size: 14px; line-height: 1.6;" data-i18n="about_license_desc">
...
export function renderPrivacyPage(baseUrl: string): string {
  return `
    ...
    <p style="color: var(--surface-fg-muted); margin-bottom: 20px;">Версия 2.0.0 (Сентябрь 2026)</p>

    <div style="display: flex; flex-direction: column; gap: 16px; font-size: 14px; line-height: 1.6;">
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">1. Собираемые данные</h3>
        <p style="margin: 0;">
      ...
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">2. Модель угроз и защита данных (Threat Model)</h3>
        <p style="margin: 0;">
      ...
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">3. Особенности работы с колонками (Yandex Quasar)</h3>
        <p style="margin: 0;">
      ...
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">4. Полное удаление данных (Right to Erasure)</h3>
        <p style="margin: 0;">
    ...
    <div style="margin-top: 24px; display: flex; gap: 12px; flex-wrap: wrap;">
      <a href="/" class="btn btn-primary" data-i18n="nav_home">На главную</a>
      <a href="/terms" class="btn btn-secondary">Условия использования</a>
    </div>
  `;
}
...
export function renderTermsPage(baseUrl: string): string {
  return `
    ...
    <div style="display: flex; flex-direction: column; gap: 16px; font-size: 14px; line-height: 1.6;">
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">1. Статус сервиса (Бета)</h3>
        <p style="margin: 0;">
      ...
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">2. Ответственность за физические устройства</h3>
        <p style="margin: 0;">
      ...
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">3. Ограничения и лимиты (Fair Use)</h3>
        <p style="margin: 0;">
    ...
    <div style="margin-top: 24px; display: flex; gap: 12px; flex-wrap: wrap;">
      <a href="/" class="btn btn-primary" data-i18n="nav_home">На главную</a>
      <a href="/security" class="btn btn-secondary">Безопасность</a>
    </div>
  `;
}
...
export function renderSecurityPage(baseUrl: string): string {
  return `
    ...
    <p style="color: var(--surface-fg-muted); margin-bottom: 20px;">Vulnerability Disclosure Policy &amp; Safe Harbor</p>

    <div style="display: flex; flex-direction: column; gap: 16px; font-size: 14px; line-height: 1.6;">
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">🛡 Safe Harbor для исследователей</h3>
        <p style="margin: 0;">
      ...
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">📬 Канал связи</h3>
        <p style="margin: 0;">
      ...
      <div style="background: var(--surface-elevated); padding: 18px; border: 1px solid var(--surface-line); border-radius: var(--mctl-radius-md);">
        <h3 style="margin-top: 0; margin-bottom: 8px;">🔒 Применяемые меры защиты</h3>
        <ul style="margin: 8px 0 0 20px; padding: 0;">
    ...
    <div style="margin-top: 24px; display: flex; gap: 12px; flex-wrap: wrap;">
      <a href="/" class="btn btn-primary" data-i18n="nav_home">На главную</a>
      <a href="/about" class="btn btn-secondary">О сервисе</a>
    </div>
  `;
}
